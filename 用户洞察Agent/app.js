...
const transcriptLines = [
  {
    speaker: "用户A",
    text: "我现在最担心的是冬天续航，官方数字看起来都不错，但我朋友说实际会打折。",
    tag: "情绪：谨慎；信号：冬季续航可信度"
  },
  {
    speaker: "主持人",
    text: "您能说说这种担心会不会直接影响最终购买吗？",
    tag: "已追问：成交阻力"
  },
  {
    speaker: "用户A",
    text: "会，尤其我们过年要回老家。不是不能充电，是不想路上一直计划这些事情。",
    tag: "信号：长途返乡；痛点：补能规划压力"
  },
  {
    speaker: "用户A",
    text: "智能座舱我挺喜欢，孩子在后排能安静一点，但有些功能太复杂我也不会天天用。",
    tag: "信号：家庭场景；需求：简单好用"
  },
  {
    speaker: "用户A",
    text: "竞品B我觉得品牌更稳，但你们这个车的内饰和屏幕体验更有新鲜感。",
    tag: "竞品对比：品牌信任 vs 座舱体验"
  }
];

const questionState = [
  { text: "家庭结构与用车场景", done: true },
  { text: "购买动机与预算范围", done: true },
  { text: "续航和补能顾虑", done: true },
  { text: "智能座舱真实价值", done: false },
  { text: "竞品B/C选择原因", done: false },
  { text: "最终成交阻力", done: false }
];

const personaData = [
  {
    title: "年轻家庭增换购用户",
    text: "25-35岁，已有孩子或计划扩大家庭，关注空间、安全、补能便利和智能座舱体验。",
    tags: ["家庭出行", "价格敏感", "重视安全"]
  },
  {
    title: "竞品观望用户",
    text: "对竞品品牌信任度较高，但容易被更好的座舱体验、配置和金融方案打动。",
    tags: ["横向比较", "品牌摇摆", "配置驱动"]
  },
  {
    title: "科技体验型用户",
    text: "喜欢新鲜的交互体验和智驾功能，但需要证明这些功能稳定、易用、可持续升级。",
    tags: ["智能座舱", "智驾兴趣", "体验优先"]
  },
  {
    title: "稳健实用型用户",
    text: "不排斥新技术，但最终看重可靠性、售后服务、保值率和真实续航。",
    tags: ["可靠性", "售后", "真实续航"]
  }
];
...
const competitorData = [
  {
    name: "本品牌A车型",
    scores: { 座舱: 88, 空间: 82, 续航信任: 64, 价格: 76 }
  },
  {
    name: "竞品B车型",
    scores: { 座舱: 70, 空间: 78, 续航信任: 82, 价格: 68 }
  },
  {
    name: "竞品C车型",
    scores: { 座舱: 74, 空间: 80, 续航信任: 76, 价格: 72 }
  }
];
...
const strategies = [
  {
    title: "核心传播主张",
    text: "把“家庭长途不焦虑”和“孩子也喜欢的智能座舱”作为双主线，减少抽象技术表达。"
  },
  {
    title: "试驾设计",
    text: "设置冬季续航解释、后排亲子体验、自动泊车和城区辅助驾驶四个固定体验点。"
  },
  {
    title: "目标客群筛选",
    text: "优先锁定有孩子、计划增换购、关注竞品B但对智能体验有期待的家庭用户。"
  },
  {
    title: "成交辅助",
    text: "用真实车主长途案例、补能路线演示和保养权益降低用户对新品牌的犹豫。"
  }
];

const knowledgeItems = [
  {
    title: "冬季续航不是数字问题，而是可信度问题",
    text: "用户不只关心CLTC或实际续航，更关心遇到低温、返乡、高速时是否需要额外规划。",
    meta: ["续航", "家庭长途", "成交阻力"]
  },
  {
    title: "智能座舱对家庭用户的价值来自陪伴和省心",
    text: "后排娱乐、语音控制、儿童场景比炫技式功能更容易被年轻家庭记住。",
    meta: ["智能座舱", "亲子场景", "产品卖点"]
  },
  {
    title: "竞品品牌信任强，但座舱体验存在突破口",
    text: "竞品B被认为更稳，本品可以用试驾中的可感知体验建立差异化。",
    meta: ["竞品B", "品牌信任", "试驾"]
  }
];
...
// ★ 自动同步：只将已完成调研的用户样本推送到共享数据桥（即用户样本库）
//    规则：只有所属调研场次状态为"已完成"的用户数据才会进入样本库
//    当前：S-001/S-003/S-004/S-006 已完成 → 24个用户进入样本库
//          S-002(进行中)和S-005(待开始)的12个用户暂不同步
...
const researchSessions = [
  {
    ...
    goal: "了解年轻家庭对纯电SUV续航、空间和智能座舱的真实购买顾虑。",
    audience: "25-35岁年轻家庭增换购用户",
    host: "用户研究组 / 华东区",
    duration: "60分钟",
    signals: "冬季续航、亲子空间、后排娱乐、补能规划"
  },
  {
    id: "S-002",
    product: "本品牌A车型",
    ...
    goal: "验证智能座舱功能在家庭场景中的感知价值和传播表达。",
    audience: "潜在用户、已试驾用户、竞品观望用户",
    host: "产品营销组 / 上海体验中心",
    duration: "90分钟",
    signals: "语音交互、儿童模式、屏幕体验、功能复杂度"
  },
  {
    id: "S-003",
    product: "本品牌A车型",
    ...
    goal: "复盘试驾后用户对动力、智驾和座舱体验的评价变化。",
    audience: "完成试驾但未下订用户",
    host: "销售运营组 / 华南区",
    duration: "45分钟",
    signals: "智驾信任、成交阻力、金融方案、家人意见"
  },
  {
    id: "S-004",
    product: "竞品B车型",
    type: "竞品车主访谈",
    status: "已完成",
    time: "2026-05-30 19:30",
    goal: "理解竞品B车主选择原因，以及本品牌可突破的体验缺口。",
    audience: "竞品B 6个月内新购车主",
    host: "竞品洞察组 / 线上访谈",
    duration: "60分钟",
    signals: "品牌信任、补能便利、座舱新鲜感、售后口碑"
  },
  {
    id: "S-005",
    product: "本品牌B车型",
    ...
    goal: "测试新车型外观、价格带和核心卖点对目标用户的吸引力。",
    audience: "30-45岁家庭第二辆车意向用户",
    host: "战略产品组 / 北京",
    duration: "75分钟",
    signals: "造型偏好、价格接受度、目标人群、卖点排序"
  },
  {
    id: "S-006",
    product: "本品牌B车型",
    ...
    goal: "分析高意向线索流失原因，定位影响下订的最后阻力。",
    audience: "留资后7天内未到店用户",
    host: "增长运营组 / 线上外呼",
    duration: "30分钟",
    signals: "价格敏感、权益比较、到店阻力、竞品截流"
  }
];
...
userSamples = [
  // S-001: 一对一深访 - 本品牌A车型
  {
    ...
    currentCar: "本田思域",
    hasChildren: true,
    surveysCompleted: ["Q-001"],
    notes: "关注冬季续航和亲子空间，计划过年回老家"
  },
  {
    id: "U-002",
    name: "李婷",
    ...
    income: "50-100万",
    carOwnership: "1辆新能源车",
    currentCar: "特斯拉Model 3",
    hasChildren: true,
    surveysCompleted: ["Q-001", "Q-002"],
    notes: "增换购用户，对智能座舱要求高"
  },
  {
    id: "U-003",
    name: "王浩",
  ...
  // S-002: 焦点小组 - 本品牌A车型
  {
    ...
    currentCar: "",
    hasChildren: false,
    surveysCompleted: ["Q-002"],
    notes: "科技爱好者，对智能座舱很感兴趣"
  },
  {
    id: "U-008",
    name: "周芳",
    ...
    currentCar: "宝马3系",
    hasChildren: true,
    surveysCompleted: ["Q-001", "Q-002", "Q-003"],
    notes: "竞品观望用户，对比多个品牌"
  },
  {
    id: "U-009",
  ...
  // S-003: 试驾回访 - 本品牌A车型
  {
    ...
    currentCar: "日产逍客",
    hasChildren: true,
    surveysCompleted: ["Q-001", "Q-003"],
    notes: "完成试驾但未下订，家人对续航有顾虑"
  },
  {
    id: "U-014",
    name: "蒋军",
    ...
    currentCar: "",
    hasChildren: false,
    surveysCompleted: ["Q-003"],
    notes: "试驾后对智驾印象深，但价格超出预算"
  },
  {
    id: "U-015",
    name: "沈丽",
  ...
  // S-004: 竞品车主访谈 - 竞品B车型
  {
    ...
    income: "30-50万",
    carOwnership: "1辆新能源车",
    currentCar: "特斯拉Model Y",
    hasChildren: true,
    surveysCompleted: ["Q-002", "Q-003"],
    notes: "竞品B车主，认可品牌但觉得座舱一般"
  },
  {
    id: "U-020",
    name: "邓娟",
  ...
  // S-005: 概念测试 - 本品牌B车型
  {
    ...
    income: "50-100万",
    carOwnership: "多辆车",
    currentCar: "宝马X5+奥迪A4",
    hasChildren: true,
    surveysCompleted: [],
    notes: "高净值用户，第二辆车给妻子用"
  },
  {
    id: "U-026",
    name: "石兰",
  ...
  },
  {
    ...
    hasChildren: true,
    surveysCompleted: ["Q-003"],
    notes: "高意向客户，但因出差推迟到店"
  }
];
console.log('userSamples数据加载完成，共', userSamples.length, '条 (其中已完成调研的用户样本：' + getCompletedUserSamples().length + ' 条)');
